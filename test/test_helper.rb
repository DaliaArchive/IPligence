...
CSV.foreach("#{File.dirname(__FILE__)}/fixtures/ipligence_test.csv") do |row|
  insert_query =
    "INSERT INTO ipligence2 (ip_from, ip_to, country_code, country_name, continent_code, continent_name, time_zone, region_code, region_name, owner, city_name, country_name, post_code, area_code, metro_code, latitude, longitude)
